...
console.log(alien); // te da el contenido del objeto
console.log(alien[key]); // te da los valores de las propiedades del objeto
// alien es el objeto
// name, race, planet, weight son las propiedades
// Wormuch, Cucusumus, Eden, 259kg son los valores de las propiedades del objeto. 
